...
def calculate_hdr_deltaITP(img1, img2):
    img1 = img1[:, :, [2, 1, 0]]
    img2 = img2[:, :, [2, 1, 0]]
    #img1 = colour.models.eotf_ST2084(img1*ratio)
    #img2 = colour.models.eotf_ST2084(img2*ratio)
    img1_ictcp = colour.RGB_to_ICtCp(img1).astype("float64")
    img2_ictcp = colour.RGB_to_ICtCp(img2).astype("float64")
