...
def define_G(opt):
    ...
    elif which_model == 'GMNet':
        import models.modules.GMNet as net
        netG = net.GMNet(in_nc=opt_net['in_nc'], out_nc=opt_net['out_nc'], nf=opt_net['nf'], nb=opt_net['nb'], act_type=opt_net['act_type'], opt=opt_net)
    else:
